...
final class APICaller {
    ...
    private struct Constants {
        static let apiKey = "c3gl6iaad3ibe39f3jl0"
        static let sandboxApiKey = "sandbox_c3gl6iaad3ibe39f3jlg"
    ...
    public func news(
        ...
        case .topStories:
            request(
                url: url(for: .topStories, queryParams: ["category": "general"]), expecting: [NewsStory].self,
                completion: completion)
    ...
    private enum Endpoint: String {
        ...
        case companyNews = "Company Views"
    ...
    private func request<T: Codable>(
        url: URL?, expecting: T.Type, completion: @escaping (Result<T, Error>) -> Void) {
